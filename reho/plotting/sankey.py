...
def add_base_flows(df_annuals, df_label, df_stv):
    ...
    df_label, df_stv, _ = add_flow('PV', 'Electrical_consumption', 'Electricity', 'PV', 'Supply_MWh', df_annuals, df_label, df_stv)
    df_label, df_stv, _ = add_flow('PV_20', 'Electrical_consumption', 'Electricity', 'PV_20', 'Supply_MWh', df_annuals, df_label, df_stv)
    df_label, df_stv, _ = add_flow('PV_100', 'Electrical_consumption', 'Electricity', 'PV_100', 'Supply_MWh', df_annuals, df_label, df_stv)
...
def df_sankey(df_Results, label='EN_long', color='ColorPastel', precision=2, units='MWh', display_label_value=True, scaling_factor=1):
    ...
    semi_auto_device = [
        ...
        'DataHeat_DHW', 'DataHeat_SH', 'HeatPump_Air', 'HeatPump_Air_10', 'HeatPump_Air_50', 'HeatPump_Air_400', 'HeatPump_Geothermal', 'HeatPump_Lake', 'HeatPump_DHN',
    ...
    electrical_storage_devices = ['Battery', 'Battery_10', 'Battery_100', 'Battery_IP', 'Battery_district', 'Battery_IP_district', 'EV_district']  # example list
