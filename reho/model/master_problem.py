...
class MasterProblem:
    ...
    def __init__(self, qbuildings_data, units, grids, parameters=None, set_indexed=None,
        ...
        if self.method['actors_problem']:
            self.lists_MP["list_constraints_MP"] += ['Owner_Link_Subsidy_to_Insulation', 'Owner_noSub', 'Renter_noSub']
    ...
    def check_Termination_criteria(self, scenario, Scn_ID=0, Pareto_ID=1):
        ...
        for h in last_SP_results:
            ...
            if self.method['actors_problem']:
                ...
                nu["ECM"] = self.get_dual_values_SPs(Scn_ID, Pareto_ID, self.iter, h, 'nu_ECM').dropna().iat[0]
                nu["DSO"] = self.get_dual_values_SPs(Scn_ID, Pareto_ID, self.iter, h, 'nu_DSO').dropna().iat[0]
    ...
    def get_dual_values_SPs(self, Scn_ID, Pareto_ID, iter, House, dual_variable):
        ...
        if dual_variable in ['pi', 'pi_GWP']:
            ...
            attribute = 'df_Dual'
        elif dual_variable in ['nu_Renters', 'nu_Owners','nu_Utility', 'nu_DSO','nu_ECM']:
