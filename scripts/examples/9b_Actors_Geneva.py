...
if __name__ == '__main__':
    ...
    qbuildings_data = reader.read_db(district_boundary='neighborhoods', district_id= 9717)
    ...
    Network_ext = pd.DataFrame([100, 2000, 2000, 2000], index=["Electricity", "NaturalGas", "Gasoline", "Mobility"],
                               columns=["Network_ext"])
    ...
    modal_split = pd.DataFrame({"min_short": [0.0, 0.0, 0.0, 0.0], "max_short": [0.0, 0.1, 1.0, 1.0]},
