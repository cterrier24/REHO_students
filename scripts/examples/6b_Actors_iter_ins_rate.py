...
if __name__ == '__main__':
    ...
    qbuildings_data = reader.read_db(district_id=234, nb_buildings= 10)
    ...
    # Set method options
    method = {'actors_problem': True, "refurbishment": True, "parallel_computation":False}
    ...
    ins_target = np.arange(0.0, 1.01, 0.1).tolist()
