...
class QBuildingsReader:
    ...
    def read_csv(self, buildings_filename='buildings.csv', nb_buildings=None, egid=None,
                 roofs_filename='roofs.csv', facades_filename='facades.csv', district=None, id_building=None, transformer=None, meteo_id=None):
        """
